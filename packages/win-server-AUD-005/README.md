...
- **Setting:** `Audit Privilege Use (Failure)`
- **Suggested value:** `Enable Failure (and Success if required)`
- **Impact:** `Low/Medium`

## What this package changes
- `auditpol` category `Privilege Use`: success=False, failure=True
...
3. Open **Audit Privilege Use (Failure)** and confirm it is set to **Enable Failure (and Success if required)**.
...
## DSC Configuration
- Configuration name: `AUD_005_Audit_Privilege_Use_Failure`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-AUD-005.zip" `
