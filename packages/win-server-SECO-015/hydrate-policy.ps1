<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-015).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Interactive logon: Do not require CTRL+ALT+DEL" (win-server-SECO-015).
  Version: 1.0.0
#>
