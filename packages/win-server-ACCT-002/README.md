...
3. Open **Maximum password age** and confirm it is set to **60 days (or org standard 60–90)**.
...
## DSC Configuration
- Configuration name: `ACCT_002_Maximum_password_age`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-ACCT-002.zip" `
