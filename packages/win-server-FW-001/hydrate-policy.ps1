<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-FW-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Enable firewall for all profiles" (win-server-FW-001).
  Version: 1.0.0
#>
