<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-UAC-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "User Account Control: Run all administrators in Admin Approval Mode" (win-server-UAC-001).
  Version: 1.0.0
#>
