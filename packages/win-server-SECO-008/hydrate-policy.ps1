<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-008).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Network security: Do not store LAN Manager hash value on next password change" (win-server-SECO-008).
  Version: 1.0.0
#>
