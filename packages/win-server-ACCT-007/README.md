...
3. Open **Account lockout threshold** and confirm it is set to **10 invalid logon attempts (WS2025 baseline uses 3; test before lowering)**.
...
## DSC Configuration
- Configuration name: `ACCT_007_Account_lockout_threshold`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-ACCT-007.zip" `
