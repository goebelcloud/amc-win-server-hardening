<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-010).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Network security: Minimum session security for NTLM SSP based (including secure RPC) clients" (win-server-SECO-010).
  Version: 1.0.0
#>
