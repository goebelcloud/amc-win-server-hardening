<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-ACCT-005).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Password must meet complexity requirements" (win-server-ACCT-005).
  Version: 1.0.0
#>
