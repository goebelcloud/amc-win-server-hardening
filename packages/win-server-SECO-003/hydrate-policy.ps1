<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-003).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Audit: Built-in Administrator (RID 500) is not named 'Administrator'" (win-server-SECO-003).
  Version: 1.0.0
#>
