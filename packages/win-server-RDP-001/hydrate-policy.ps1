<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-RDP-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Require user authentication for remote connections by using Network Level Authentication" (win-server-RDP-001).
  Version: 1.0.0
#>
