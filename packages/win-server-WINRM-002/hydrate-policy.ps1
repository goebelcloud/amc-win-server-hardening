<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-WINRM-002).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Disallow Basic authentication" (win-server-WINRM-002).
  Version: 1.0.0
#>
