...
- **Setting:** `Audit Policy Change (Success/Failure)`
- **Suggested value:** `Enable Success and Failure`
- **Impact:** `Low/Medium`

## What this package changes
- `auditpol` category `Policy Change`: success=True, failure=True
...
3. Open **Audit Policy Change (Success/Failure)** and confirm it is set to **Enable Success and Failure**.
...
## DSC Configuration
- Configuration name: `AUD_004_Audit_Policy_Change_Success_Failure`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-AUD-004.zip" `
