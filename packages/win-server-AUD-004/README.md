...
Expected:
- `output/mof/AUD-004/localhost.mof`
- `output/zip/AUD-004/win-server-AUD-004.zip`
...
Expected:
- `output/policy/AUD-004/deployIfNotExists.json`
- `output/policy/AUD-004/deployIfNotExists.enhanced.json`
...
Expected:
- An assignment for `win-server-AUD-004` exists.
- `properties.guestConfiguration.name = win-server-AUD-004`
...
Expected:
- recent entries for `win-server-AUD-004`
