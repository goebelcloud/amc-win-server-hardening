<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-006).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Network access: Do not allow anonymous enumeration of SAM accounts and shares" (win-server-SECO-006).
  Version: 1.0.0
#>
