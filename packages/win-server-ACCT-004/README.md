...
3. Open **Minimum password length** and confirm it is set to **14 characters**.
...
## DSC Configuration
- Configuration name: `ACCT_004_Minimum_password_length`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-ACCT-004.zip" `
