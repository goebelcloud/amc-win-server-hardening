<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-UAC-002).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "User Account Control: Switch to the secure desktop when prompting for elevation" (win-server-UAC-002).
  Version: 1.0.0
#>
