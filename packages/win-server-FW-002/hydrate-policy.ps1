<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-FW-002).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Enable firewall logging" (win-server-FW-002).
  Version: 1.0.0
#>
