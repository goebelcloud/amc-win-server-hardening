<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-LSA-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Enable LSA protection (RunAsPPL)" (win-server-LSA-001).
  Version: 1.0.0
#>
