<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-NET-002).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Turn off AutoPlay / AutoRun" (win-server-NET-002).
  Version: 1.0.0
#>
