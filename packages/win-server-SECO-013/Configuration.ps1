...
Package: win-server-SECO-013 - Microsoft network client: Digitally sign communications (always)
...
Configuration SECO_013_Microsoft_network_client_Digitally_sign_communicati {
