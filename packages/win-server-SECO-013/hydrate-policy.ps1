<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-013).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Microsoft network server: Digitally sign communications (always)" (win-server-SECO-013).
  Version: 1.0.0
#>
