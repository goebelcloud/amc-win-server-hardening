<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-011).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Network security: Minimum session security for NTLM SSP based (including secure RPC) servers" (win-server-SECO-011).
  Version: 1.0.0
#>
