<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-004).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Accounts: Rename guest account" (win-server-SECO-004).
  Version: 1.0.0
#>
