...
3. Open **Enforce password history** and confirm it is set to **24 passwords remembered**.
...
## DSC Configuration
- Configuration name: `ACCT_001_Enforce_password_history`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-ACCT-001.zip" `
