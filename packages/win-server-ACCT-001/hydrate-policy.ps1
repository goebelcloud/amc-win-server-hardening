<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-ACCT-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Enforce password history" (win-server-ACCT-001).
  Version: 1.0.0
#>
