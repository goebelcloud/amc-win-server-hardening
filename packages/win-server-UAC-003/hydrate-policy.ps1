<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-UAC-003).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "User Account Control: Behavior of the elevation prompt for administrators in Admin Approval Mode" (win-server-UAC-003).
  Version: 1.0.0
#>
