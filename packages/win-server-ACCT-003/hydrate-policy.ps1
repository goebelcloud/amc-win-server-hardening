<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-ACCT-003).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Minimum password age" (win-server-ACCT-003).
  Version: 1.0.0
#>
