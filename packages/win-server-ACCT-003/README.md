...
3. Open **Minimum password age** and confirm it is set to **1 day**.
...
## DSC Configuration
- Configuration name: `ACCT_003_Minimum_password_age`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-ACCT-003.zip" `
