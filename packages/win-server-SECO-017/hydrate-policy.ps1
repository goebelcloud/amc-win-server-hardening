<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-017).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Shutdown: Allow system to be shut down without having to log on" (win-server-SECO-017).
  Version: 1.0.0
#>
