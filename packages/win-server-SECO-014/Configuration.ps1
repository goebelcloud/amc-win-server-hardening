...
Package: win-server-SECO-014 - Microsoft network server: Digitally sign communications (always)
...
Configuration SECO_014_Microsoft_network_server_Digitally_sign_communicati {
