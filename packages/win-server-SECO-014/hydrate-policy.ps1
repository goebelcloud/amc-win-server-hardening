<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-014).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Interactive logon: Do not display last user name" (win-server-SECO-014).
  Version: 1.0.0
#>
