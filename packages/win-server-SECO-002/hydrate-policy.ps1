<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-002).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Accounts: Guest account status" (win-server-SECO-002).
  Version: 1.0.0
#>
