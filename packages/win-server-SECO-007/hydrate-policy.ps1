<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-007).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Network access: Let Everyone permissions apply to anonymous users" (win-server-SECO-007).
  Version: 1.0.0
#>
