...
Expected:
- `output/mof/AUD-003/localhost.mof`
- `output/zip/AUD-003/win-server-AUD-003.zip`
...
Expected:
- `output/policy/AUD-003/deployIfNotExists.json`
- `output/policy/AUD-003/deployIfNotExists.enhanced.json`
...
Expected:
- An assignment for `win-server-AUD-003` exists.
- `properties.guestConfiguration.name = win-server-AUD-003`
...
Expected:
- recent entries for `win-server-AUD-003`
