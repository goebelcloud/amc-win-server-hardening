...
- `auditpol` category `Account Management`: success=True, failure=True
...
3. Open **Audit Account Management (Success/Failure)** and confirm it is set to **Enable Success and Failure**.
...
## DSC Configuration
- Configuration name: `AUD_003_Audit_Account_Management_Success_Failure`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-AUD-003.zip" `
