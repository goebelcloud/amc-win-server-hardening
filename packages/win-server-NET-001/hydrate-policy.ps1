<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-NET-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Disable SMBv1 (Client and Server)" (win-server-NET-001).
  Version: 1.0.0
#>
