<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-RDP-003).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Do not allow passwords to be saved" (win-server-RDP-003).
  Version: 1.0.0
#>
