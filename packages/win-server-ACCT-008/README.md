...
3. Open **Account lockout duration** and confirm it is set to **15 minutes**.
...
## DSC Configuration
- Configuration name: `ACCT_008_Account_lockout_duration`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-ACCT-008.zip" `
