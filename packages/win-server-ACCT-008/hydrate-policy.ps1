<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-ACCT-008).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Account lockout duration" (win-server-ACCT-008).
  Version: 1.0.0
#>
