<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-009).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Network security: LAN Manager authentication level" (win-server-SECO-009).
  Version: 1.0.0
#>
