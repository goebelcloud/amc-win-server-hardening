<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-SECO-012).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Microsoft network client: Digitally sign communications (always)" (win-server-SECO-012).
  Version: 1.0.0
#>
