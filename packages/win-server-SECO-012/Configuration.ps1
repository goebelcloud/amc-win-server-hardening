...
Package: win-server-SECO-012 - Network security: Minimum session security for NTLM SSP based (including secure RPC) servers
...
Configuration SECO_012_Network_security_Minimum_session_security_for_NTLM_ {
    Import-DscResource -ModuleName PSDscResources

    Node "localhost" {
        Registry "win-server-SECO-012_1" {
            Ensure    = "Present"
