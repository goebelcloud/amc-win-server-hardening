<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-LOG-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "PowerShell Script Block Logging" (win-server-LOG-001).
  Version: 1.0.0
#>
