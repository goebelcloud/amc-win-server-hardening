<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-AUD-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Audit Account Logon (Success/Failure)" (win-server-AUD-001).
  Version: 1.0.0
#>
