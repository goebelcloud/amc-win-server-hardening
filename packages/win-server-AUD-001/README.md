...
Expected:
- `output/mof/AUD-001/localhost.mof`
- `output/zip/AUD-001/win-server-AUD-001.zip`
...
Expected:
- `output/policy/AUD-001/deployIfNotExists.json`
- `output/policy/AUD-001/deployIfNotExists.enhanced.json`
...
Expected:
- An assignment for `win-server-AUD-001` exists.
- `properties.guestConfiguration.name = win-server-AUD-001`
...
Expected:
- recent entries for `win-server-AUD-001`
