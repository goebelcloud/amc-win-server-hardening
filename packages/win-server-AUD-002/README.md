...
Expected:
- `output/mof/AUD-002/localhost.mof`
- `output/zip/AUD-002/win-server-AUD-002.zip`
...
Expected:
- `output/policy/AUD-002/deployIfNotExists.json`
- `output/policy/AUD-002/deployIfNotExists.enhanced.json`
...
Expected:
- An assignment for `win-server-AUD-002` exists.
- `properties.guestConfiguration.name = win-server-AUD-002`
...
Expected:
- recent entries for `win-server-AUD-002`
