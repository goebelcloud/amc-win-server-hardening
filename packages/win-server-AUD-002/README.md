...
- **Setting:** `Audit Logon/Logoff (Success/Failure)`
- **Suggested value:** `Enable Success and Failure`
- **Impact:** `Low/Medium`

## What this package changes
- `auditpol` category `Logon/Logoff`: success=True, failure=True
...
3. Open **Audit Logon/Logoff (Success/Failure)** and confirm it is set to **Enable Success and Failure**.
...
## DSC Configuration
- Configuration name: `AUD_002_Audit_Logon_Logoff_Success_Failure`
...
2. From this package directory, run:
   ...
   ./build.ps1 `
     ...
     -ContentUri "https://<storage>.blob.core.windows.net/<container>/win-server-AUD-002.zip" `
