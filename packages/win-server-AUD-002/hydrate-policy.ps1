<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-AUD-002).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Audit Logon/Logoff (Success/Failure)" (win-server-AUD-002).
  Version: 1.0.0
#>
