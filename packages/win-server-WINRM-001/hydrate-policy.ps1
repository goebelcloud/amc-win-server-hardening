<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-WINRM-001).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Allow unencrypted traffic" (win-server-WINRM-001).
  Version: 1.0.0
#>
