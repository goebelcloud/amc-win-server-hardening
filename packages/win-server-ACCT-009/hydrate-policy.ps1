<#
.SYNOPSIS
  Hydrate the enhanced policy JSON for this package (win-server-ACCT-009).
...
.NOTES
  ...
  Purpose: Hydrates the enhanced Azure Policy JSON template for the setting "Reset account lockout counter after" (win-server-ACCT-009).
  Version: 1.0.0
#>
